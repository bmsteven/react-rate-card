...
var customCurrencyConverter = function (
  amount,
  currencies,
  coins,
  ...
  coins.forEach(function (el, index) {
    if (
      index ===
      (coins === null || coins === void 0 ? void 0 : coins.length) - 1
    ) {
  ...
  var coinslayerApi =
    ...
    newCoins +
    "&target=USD"
  var currencylayerApi =
    "https://apilayer.net/api/live?access_key=" +
    currencylayer_access_key +
    "&currencies=" +
    newCurrencies +
    "&source=USD&format=1"
  ...
  axios
    ...
    .then(function (res) {
      ...
      if (
        (_a = res === null || res === void 0 ? void 0 : res.data) === null ||
        _a === void 0
          ? void 0
          : _a.rates
      ) {
        setCoinsResults(
          (_b = res === null || res === void 0 ? void 0 : res.data) === null ||
            _b === void 0
            ? void 0
            : _b.rates
        )
      ...
      if ((_c = res.data) === null || _c === void 0 ? void 0 : _c.error)
        setCoinsError(
          (_e =
            (_d = res === null || res === void 0 ? void 0 : res.data) ===
              null || _d === void 0
              ? void 0
...
var RateCard = function (_a) {
  var _b = _a.coins,
    coins = _b === void 0 ? customCoins : _b,
    _c = _a.currencies,
    currencies = _c === void 0 ? customCurrencies : _c,
    _d = _a.defaultSelected,
    defaultSelected = _d === void 0 ? coins[0] : _d,
    customStyles = _a.customStyles,
    customClass = _a.customClass,
    inputClass = _a.inputClass,
    inputStyle = _a.inputStyle,
    currencyStyle = _a.currencyStyle,
    currencyClass = _a.currencyClass,
    currencylayer_access_key = _a.currencylayer_access_key,
    coinslayer_access_key = _a.coinslayer_access_key,
    errorStyle = _a.errorStyle,
    errorClass = _a.errorClass
  var _e = useState(true),
    coinsLoading = _e[0],
    setCoinsLoading = _e[1]
  var _f = useState(true),
    currenciesLoading = _f[0],
    setCurrenciesLoading = _f[1]
  var _g = useState(""),
    coinsError = _g[0],
    setCoinsError = _g[1]
  var _h = useState(""),
    currenciesError = _h[0],
    setCurrenciesError = _h[1]
  var _j = useState(null),
    rates = _j[0],
    setRates = _j[1]
  var _k = useState(0),
    conversionRate = _k[0],
    setConversionRate = _k[1]
  var _l = useState(null),
    coin = _l[0],
    setCoins = _l[1]
  var _m = useState(null),
    currenciesResults = _m[0],
    setCurrenciesResults = _m[1]
  var _o = useState(null),
    coinsResult = _o[0],
    setCoinsResults = _o[1]
  var _p = useState({
    ...
    variables = _p[0],
    setVariables = _p[1]
  var selected = variables.selected,
    amount = variables.amount,
    displayValue = variables.displayValue
  var Option = Select.Option
  var handleSelectChange = useCallback(
    function (value) {
  ...
  var handleValueChange = function (e) {
    ...
    if (parseFloat(cleanValue({ value: value })) >= 0) {
      setVariables(
        __assign(__assign({}, variables), {
          amount: cleanValue({ value: value }),
          displayValue: cleanValue({ value: value }),
        })
      )
    } else {
      setVariables(
        ...
        var arr =
          (_a =
            Object === null || Object === void 0
              ? void 0
              : Object.keys(currenciesResults)) === null || _a === void 0
            ? void 0
            : _a.map(function (key) {
                return key && { rate: key, value: currenciesResults[key] }
              })
        setRates(arr)
      }
    },
      ...
      if (coinsResult) {
        var arr =
          (_a =
            Object === null || Object === void 0
              ? void 0
              : Object.keys(coinsResult)) === null || _a === void 0
            ? void 0
            : _a.map(function (key) {
                return key && { rate: key, value: coinsResult[key] }
              })
        setCoins(arr)
      }
    },
  ...
  useEffect(
    function () {
      var y = 0
      if (coin) {
        coin === null || coin === void 0
          ? void 0
          : coin.forEach(function (el) {
              var _a
              if (
                (_a = el === null || el === void 0 ? void 0 : el.rate) ===
                  null || _a === void 0
                  ? void 0
                  : _a.includes(selected)
              ) {
      ...
      React.createElement(
        ...
        React.createElement(
          Select,
          {
            ...
            value: selected,
            style: __assign(
              { width: "100%", textAlign: "right", fontWeight: 600 },
              inputStyle
            ),
            onChange: handleSelectChange,
            className: "input-field select-input " + inputClass,
          },
          (coins === null || coins === void 0 ? void 0 : coins.length) > 0 &&
            coins.map(function (option) {
              return React.createElement(
                Option,
...
var Rate = function (_a) {
  var currency = _a.currency,
    amount = _a.amount,
    conversionRate = _a.conversionRate,
    rates = _a.rates,
    coins = _a.coins,
    currencyClass = _a.currencyClass,
    currencyStyle = _a.currencyStyle
  var _b = useState("0.00"),
    newAmount = _b[0],
    setAmount = _b[1]
  var _c = useState("0.00"),
    displayAmount = _c[0],
    setDisplayAmount = _c[1]
  var splitValue = displayAmount.split(".")
  var decimals = function () {
    var _a
    if (displayAmount) {
      var splitDecimals =
        (_a = splitValue[1]) === null || _a === void 0 ? void 0 : _a.split("")
      if (
        (splitDecimals === null || splitDecimals === void 0
          ? void 0
          : splitDecimals.length) > 0
      ) {
        return (
  ...
  useEffect(
    function () {
      if (rates) {
        var v_1, y_1
        rates === null || rates === void 0
          ? void 0
          : rates.forEach(function (el) {
              var _a
              if (
                coins === null || coins === void 0
                  ? void 0
                  : coins.find(function (e) {
  ...
  return React.createElement(
    ...
    {
      style: __assign(
        { textAlign: "right", marginBottom: "2.5rem", fontWeight: 600 },
        currencyStyle
      ),
